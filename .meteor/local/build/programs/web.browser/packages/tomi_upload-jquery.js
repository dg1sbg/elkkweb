...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                       //
Uploader = {                                                                                                           // 1
  logLevels: { "debug": 0, "error": 1 },                                                                               // 2
  logLevel: 1,                                                                                                         // 3
  log: function(level, text) {                                                                                         // 4
    if (level >= Uploader.logLevel) {                                                                                  // 5
      console.log(text);                                                                                               // 6
    }                                                                                                                  // 7
  },                                                                                                                   // 8
  localisation: {                                                                                                      // 9
  ...
  UI: {                                                                                                                // 17
    bootstrap: {                                                                                                       // 18
      upload: 'btn btn-primary btn-file upload-control',                                                               // 19
      progressOuter: 'form-control upload-control',                                                                    // 20
      progressInner: 'progressInner',                                                                                  // 21
      progressBar: 'progress-bar progress-bar-success progress-bar-striped',                                           // 22
      removeButton: 'btn btn-default upload-control remove',                                                           // 23
      removeButtonIcon: 'glyphicon glyphicon-remove',                                                                  // 24
      startButton: 'btn btn-info upload-control start',                                                                // 25
      startButtonIcon: 'glyphicon glyphicon-upload',                                                                   // 26
      doneButton: 'btn btn-default upload-control done',                                                               // 27
      doneButtonIcon: 'glyphicon glyphicon-ok',                                                                        // 28
      cancelButton: 'btn btn-danger upload-control cancel',                                                            // 29
      cancelButtonIcon: 'glyphicon glyphicon-stop',                                                                    // 30
      cancelledButton: 'btn btn-warning upload-control',                                                               // 31
      cancelledButtonIcon: 'glyphicon glyphicon-cross'                                                                 // 32
    },                                                                                                                 // 33
    semanticUI: {                                                                                                      // 34
      upload: 'ui icon button btn-file leftButton upload-control',                                                     // 35
      progressOuter: 'progressOuter',                                                                                  // 36
      progressInner: 'semantic progressInner',                                                                         // 37
      progressBar: 'bar progress-bar',                                                                                 // 38
      removeButton: 'ui red button upload-control remove rightButton',                                                 // 39
      removeButtonIcon: 'trash icon',                                                                                  // 40
      startButton: 'ui button primary upload-control start rightButton',                                               // 41
      startButtonIcon: 'upload icon',                                                                                  // 42
      doneButton: 'ui green button upload-control rightButton done',                                                   // 43
      doneButtonIcon: 'icon thumbs up',                                                                                // 44
      cancelButton: 'ui yellow button upload-control cancel rightButton',                                              // 45
      cancelButtonIcon: 'icon stop',                                                                                   // 46
      cancelledButton: 'ui yellow button upload-control rightButton'                                                   // 47
    }                                                                                                                  // 48
  },                                                                                                                   // 49
  uploadUrl: '/upload',                                                                                                // 50
  createName: function (templateContext) {                                                                             // 51
    if (templateContext.queue.length == 1) {                                                                           // 52
      var file = templateContext.queue[0];                                                                             // 53
      templateContext.info.set(file);                                                                                  // 54
    } else {                                                                                                           // 55
      // calculate size                                                                                                // 56
      var file = {                                                                                                     // 57
        name: templateContext.queue.length + ' files',                                                                 // 58
        size: templateContext.queue.size                                                                               // 59
      }                                                                                                                // 60
      templateContext.info.set(file);                                                                                  // 61
    }                                                                                                                  // 62
  },                                                                                                                   // 63
  /**                                                                                                                  // 64
   * Starts upload                                                                                                     // 65
   * @param e                                                                                                          // 66
   * @param {string} name Name of the file in the queue that we want to upload                                         // 67
   */                                                                                                                  // 68
  startUpload: function (e, name) {                                                                                    // 69
    if (e) e.preventDefault();                                                                                         // 70
                                                                                                                       // 71
    if (this.queue.length == 0) return;                                                                                // 72
                                                                                                                       // 73
    var that = this;                                                                                                   // 74
                                                                                                                       // 75
    $.each(this.queue, function (index, queueItem) {                                                                   // 76
                                                                                                                       // 77
      var data = queueItem.data;                                                                                       // 78
      if (name && data.files[0].name !== name) return true;                                                            // 79
                                                                                                                       // 80
      data.jqXHR = data.submit()                                                                                       // 81
        .done(function (data, textStatus, jqXHR) {                                                                     // 82
          // remove from queue                                                                                         // 83
          that.queue.splice(that.queue.indexOf(queueItem), 1);                                                         // 84
                                                                                                                       // 85
          Uploader.log(Uploader.logLevels.debug, 'data.sumbit.done: textStatus= ' + textStatus);                       // 86
                                                                                                                       // 87
          if (Uploader.status) {                                                                                       // 88
            Uploader.status(false, data, textStatus, jqXHR);                                                           // 89
          }                                                                                                            // 90
        })                                                                                                             // 91
        .fail(function (jqXHR, textStatus, errorThrown) {                                                              // 92
          // remove from queue                                                                                         // 93
          that.queue.splice(that.queue.indexOf(queueItem), 1);                                                         // 94
                                                                                                                       // 95
          if (jqXHR.statusText === 'abort') {                                                                          // 96
            that.info.set({                                                                                            // 97
              name: 'Aborted',                                                                                         // 98
              size: 0                                                                                                  // 99
            })                                                                                                         // 100
            ...
            that.info.set({                                                                                            // 102
              name: 'Failed: ' + jqXHR.responseText + ' ' + jqXHR.status + ' ' + jqXHR.statusText,                     // 103
              size: 0                                                                                                  // 104
            })                                                                                                         // 105
          }                                                                                                            // 106
          if (Uploader.status) {                                                                                       // 107
            Uploader.status(true, data, textStatus, jqXHR);                                                            // 108
          }                                                                                                            // 109
                                                                                                                       // 110
          Uploader.log(Uploader.logLevels.debug, 'data.sumbit.fail: ' + jqXHR.responseText + ' ' + jqXHR.status + ' ' + jqXHR.statusText);
        })                                                                                                             // 112
        .always(function (data, textStatus, jqXHR) {                                                                   // 113
          Uploader.log(Uploader.logLevels.debug, 'data.sumbit.always:  textStatus= ' + textStatus);                    // 114
        });                                                                                                            // 115
    });                                                                                                                // 116
  },                                                                                                                   // 117
  formatProgress: function (file, progress, bitrate) {                                                                 // 118
    return progress + "%&nbsp;of&nbsp;" + file + "&nbsp;<span style='font-size:smaller'>@&nbsp;" + bytesToSize(bitrate) + "&nbsp;/&nbsp;sec</span>"
  },                                                                                                                   // 120
  removeFromQueue: function (e, name) {                                                                                // 121
    e.preventDefault();                                                                                                // 122
                                                                                                                       // 123
    // remove from data queue                                                                                          // 124
    var that = this;                                                                                                   // 125
    $.each(this.queue, function (index, item) {                                                                        // 126
      // skip all with different name                                                                                  // 127
      if (item.name === name) {                                                                                        // 128
        that.queue.splice(index, 1);                                                                                   // 129
        return false;                                                                                                  // 130
      }                                                                                                                // 131
    });                                                                                                                // 132
                                                                                                                       // 133
    // set the queueView                                                                                               // 134
    this.queueView.set(this.queue);                                                                                    // 135
                                                                                                                       // 136
    // update name                                                                                                     // 137
    Uploader.createName(this);                                                                                         // 138
  },                                                                                                                   // 139
  reset: function(e) {                                                                                                 // 140
    e.preventDefault();                                                                                                // 141
    this.globalInfo.set({running: false, cancelled: false, progress: 0, bitrate: 0});                                  // 142
    this.info.set("");                                                                                                 // 143
  },                                                                                                                   // 144
  cancelUpload: function (e, name) {                                                                                   // 145
    e.preventDefault();                                                                                                // 146
                                                                                                                       // 147
    var that = this;                                                                                                   // 148
    $.each(this.queue, function (index, queueItem) {                                                                   // 149
      // skip all with different name                                                                                  // 150
      if (name && queueItem.name !== name) return true;                                                                // 151
                                                                                                                       // 152
      // cancel upload of non completed files                                                                          // 153
      if (that.queue[queueItem.name].get().progress !== 100) {                                                         // 154
        queueItem.data.jqXHR.abort();                                                                                  // 155
                                                                                                                       // 156
        // set status to redraw interface                                                                              // 157
        that.queue[queueItem.name].set({running: false, cancelled: true, progress: 0, bitrate: 0});                    // 158
      }                                                                                                                // 159
    });                                                                                                                // 160
                                                                                                                       // 161
    // mark global as cancelled                                                                                        // 162
    if (!name) {                                                                                                       // 163
      this.globalInfo.set({running: false, cancelled: true, progress: 0, bitrate: 0})                                  // 164
    }                                                                                                                  // 165
  },                                                                                                                   // 166
  init: function (data) {                                                                                              // 167
    // this is used to view the queue in the interface                                                                 // 168
    data.queueView = new ReactiveVar([]);                                                                              // 169
    // this holds all the data about the queue                                                                         // 170
    data.queue = [];                                                                                                   // 171
    // info about the global item being processed                                                                      // 172
    data.info = new ReactiveVar;                                                                                       // 173
    // info about global progress                                                                                      // 174
    data.globalInfo = new ReactiveVar({running: false, progress: 0, bitrate: 0});                                      // 175
  },                                                                                                                   // 176
  render: function () {                                                                                                // 177
    // template context is the template instance itself                                                                // 178
    var templateContext = this;                                                                                        // 179
    templateContext.progressBar = this.$('.progress-bar');                                                             // 180
    templateContext.progressLabel = this.$('.progress-label');                                                         // 181
    templateContext.uploadControl = this.$('.jqUploadclass');                                                          // 182
    templateContext.dropZone = this.$('.jqDropZone');                                                                  // 183
                                                                                                                       // 184
    // this.data holds the template context (arguments supplied to the template in HTML)                               // 185
    var dataContext = this.data;                                                                                       // 186
                                                                                                                       // 187
    // attach the context to the form object (so that we can access it in the callbacks such as add() etc.)            // 188
    this.find('form').uploadContext = templateContext;                                                                 // 189
                                                                                                                       // 190
    // set the upload related callbacks for HTML node that has jqUploadclass specified for it                          // 191
    // Example html node: <input type="file" class="jqUploadclass" />                                                  // 192
    templateContext.uploadControl.fileupload({                                                                         // 193
      url: Uploader.uploadUrl,                                                                                         // 194
      dataType: 'json',                                                                                                // 195
      dropZone: templateContext.dropZone,                                                                              // 196
      add: function (e, data) {                                                                                        // 197
        Uploader.log(Uploader.logLevels.debug, 'render.add ');                                                         // 198
                                                                                                                       // 199
        // validate before adding                                                                                      // 200
        if (dataContext != null &&                                                                                     // 201
            dataContext.callbacks != null &&                                                                           // 202
            dataContext.callbacks.validate != null &&                                                                  // 203
           !dataContext.callbacks.validate(data.files)) {                                                              // 204
          return;                                                                                                      // 205
        }                                                                                                              // 206
                                                                                                                       // 207
        // adding file will clear the queue                                                                            // 208
        if (dataContext == null ||                                                                                     // 209
           !dataContext.multiple) {                                                                                    // 210
          templateContext.queue = [];                                                                                  // 211
          templateContext.queueView.set([]);                                                                           // 212
        }                                                                                                              // 213
                                                                                                                       // 214
        // update the queue collection, so that the ui gets updated                                                    // 215
        $.each(data.files, function (index, file) {                                                                    // 216
          var item = file;                                                                                             // 217
          item.data = data;                                                                                            // 218
          templateContext.queue[file.name] = new ReactiveVar({running: false, progress: 0});                           // 219
          templateContext.queue.push(item);                                                                            // 220
          templateContext.queue.size += parseInt(file.size);                                                           // 221
        });                                                                                                            // 222
                                                                                                                       // 223
        // say name                                                                                                    // 224
        Uploader.createName(templateContext);                                                                          // 225
                                                                                                                       // 226
        // set template context                                                                                        // 227
        templateContext.queueView.set(templateContext.queue);                                                          // 228
                                                                                                                       // 229
        // we can automatically start the upload                                                                       // 230
        if (templateContext.autoStart) {                                                                               // 231
          Uploader.startUpload.call(templateContext);                                                                  // 232
        }                                                                                                              // 233
                                                                                                                       // 234
      }, // end of add callback handler                                                                                // 235
      done: function (e, data) {                                                                                       // 236
        Uploader.log(Uploader.logLevels.debug, 'render.done ');                                                        // 237
                                                                                                                       // 238
        templateContext.globalInfo.set({running: false, progress: 100});                                               // 239
                                                                                                                       // 240
        $.each(data.result.files, function (index, file) {                                                             // 241
          Uploader.finished(index, file, templateContext);                                                             // 242
                                                                                                                       // 243
          // notify user                                                                                               // 244
          if (dataContext.callbacks != null &&                                                                         // 245
              dataContext.callbacks.finished != null) {                                                                // 246
            dataContext.callbacks.finished(index, file, templateContext);                                              // 247
          }                                                                                                            // 248
        });                                                                                                            // 249
      },                                                                                                               // 250
      fail: function (e, data) {                                                                                       // 251
        Uploader.log(Uploader.logLevels.debug, 'render.fail ');                                                        // 252
      },                                                                                                               // 253
      progress: function (e, data) {                                                                                   // 254
        // file progress is displayed only when single file is uploaded                                                // 255
        var fi = templateContext.queue[data.files[0].name];                                                            // 256
        if (fi) {                                                                                                      // 257
          fi.set({                                                                                                     // 258
            running: true,                                                                                             // 259
            progress: parseInt(data.loaded / data.total * 100, 10),                                                    // 260
            bitrate: data.bitrate                                                                                      // 261
          });                                                                                                          // 262
        }                                                                                                              // 263
      },                                                                                                               // 264
      progressall: function (e, data) {                                                                                // 265
        templateContext.globalInfo.set({                                                                               // 266
          running: true,                                                                                               // 267
          progress: parseInt(data.loaded / data.total * 100, 10),                                                      // 268
          bitrate: data.bitrate                                                                                        // 269
        });                                                                                                            // 270
      },                                                                                                               // 271
      drop: function (e, data) { // called when files are dropped onto ui                                              // 272
        $.each(data.files, function (index, file) {                                                                    // 273
          Uploader.log(Uploader.logLevels.debug, "render.drop file: " + file.name);                                    // 274
        });                                                                                                            // 275
      },                                                                                                               // 276
      change: function (e, data) { // called when input selection changes (file selected)                              // 277
        // clear the queue, this is used to visualise all the data                                                     // 278
        templateContext.queue = [];                                                                                    // 279
        templateContext.queue.size = 0;                                                                                // 280
        templateContext.progressBar.css('width', '0%');                                                                // 281
        templateContext.globalInfo.set({running: false, progress: 0});                                                 // 282
                                                                                                                       // 283
        $.each(data.files, function (index, file) {                                                                    // 284
          Uploader.log(Uploader.logLevels.debug, 'render.change file: ' + file.name);                                  // 285
        });                                                                                                            // 286
      }                                                                                                                // 287
    })                                                                                                                 // 288
      .prop('disabled', ($.support != null && $.support.fileInput != null) ? !$.support.fileInput : false)             // 289
      .parent().addClass(($.support != null && $.support.fileInput != null && !$.support.fileInput) ? 'disabled' : undefined);
  },                                                                                                                   // 291
  finished: function () {                                                                                              // 292
  }                                                                                                                    // 293
}                                                                                                                      // 294
                                                                                                                       // 295
bytesToSize = function (bytes) {                                                                                       // 296
  if (bytes == 0) return '0 Byte';                                                                                     // 297
  var k = 1000;                                                                                                        // 298
  var sizes = ['Bytes', 'KB', 'MB', 'GB', 'TB', 'PB', 'EB', 'ZB', 'YB'];                                               // 299
  var i = Math.floor(Math.log(bytes) / Math.log(k));                                                                   // 300
  return (bytes / Math.pow(k, i)).toPrecision(3) + '&nbsp;' + sizes[i];                                                // 301
}                                                                                                                      // 302
                                                                                                                       // 303
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
